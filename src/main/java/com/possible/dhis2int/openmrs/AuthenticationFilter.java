...
public class AuthenticationFilter extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		AuthenticationResponse authenticationResponse = request.getRequestURI().contains("submit")
		...
		System.out.println("Prehandle method - cookies " + cookies.getAllCookieValues());
	...
	private boolean redirectToLogin(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
			throws IOException {
